...
class AuthorizeNetComponent extends Component {
    ...
    */
    ...
    function chargeCard($loginid, $trankey, $ccnum, $ccexpmonth, $ccexpyear, $ccver, $live= false, $amount, $tax, $shipping, $desc, $billinginfo, $email, $phone, $shippinginfo) {
       ...
       // $auth_net_url                = "https://secure.authorize.net/gateway/transact.dll";
        ...
        $fileds = rtrim($fields,"&")."x_ship_to_country=";
