...
class CaptchaComponent extends Component{
	...
	function create($settings = array()) {
		...
		$textbox = imagettfbbox($font_size, 0, WWW_ROOT.$this->settings['font'], $code) or die('Error in imagettfbbox function');
		$x = ($width - $textbox[4])/2;
		$y = ($height - $textbox[5])/2;
		$y -= 5;
		imagettftext($image, $font_size, 0, $x, $y, $text_color, WWW_ROOT.$this->settings['font'] , $code) or die('Error in imagettftext function');
