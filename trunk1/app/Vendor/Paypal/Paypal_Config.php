...
class Paypal_Config {
	...
	public $developer_account_email = 'sheetalpandhi@zapbuild.com';		// This is what you use to sign in to http://developer.paypal.com.  Only required for Adaptive Payments.
	...
	public function Paypal_Config() {
		...
		$this->domain = $this->sandbox ? 'http://1337iot.zapbuild.com/' : 'http://www.example.com/';
		...
		$this->api_username = $this->sandbox ? 'sheetalpandhi_api1.zapbuild.com' : 'LIVE_API_USERNAME';
		$this->api_password = $this->sandbox ? '1371545365' : 'LIVE_API_PASSWORD';
		$this->api_signature = $this->sandbox ? 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-An0u-1D5Qd66bxaI1hz7H1UfkW19' : 'LIVE_API_SIGNATURE';
