<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('remembertoken'); ?></th>
			<th><?php echo $this->Paginator->sort('type'); ?></th>
			<th><?php echo $this->Paginator->sort('status'); ?></th>
			<th><?php echo $this->Paginator->sort('passwordstatus'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['remembertoken']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['type']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['status']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['passwordstatus']); ?>&nbsp;</td>
