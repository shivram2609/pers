...
(function (a) {
    ...
    a.stretch = function (l, q, p, h, n, j) {
        ...
        var d = p / n,
            ...
            o = 0,
            k = 0,
            c = {}, e = (q.tagName.toLowerCase() == "video"),
            f = false,
            m;
        if (e) {
            a.transform(q)
...
(function (l) {
    ...
    l.view = function (N, I) {
        var M = N,
            ...
            an, Z, X, au, D = 0,
            aF = 2000,
            F, aO, S, aE, aP, aA, aq, aw = x.extend({}, K.componentConfig("logo")),
            ao, aJ, U, ah = (K.mobilecontrols),
            aG = s,
            ai, Q, aB, ax = new a.eventdispatcher();
        x.extend(this, ax);
